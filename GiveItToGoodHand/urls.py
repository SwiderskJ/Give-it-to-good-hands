...
from user_app.views import LoginView, RegisterView, LogoutView, ProfileView, ArchiveDonationView
...
urlpatterns = [
    ...
    path('archive/<int:donation_id>', ArchiveDonationView.as_view(), name='archive')
]
